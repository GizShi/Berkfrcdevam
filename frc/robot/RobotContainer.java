...
public class RobotContainer {
  ...
  private final LogitechController logitechcontroller = new Joystick(1);
  ...
  public RobotContainer() {
    ...
    //by default intake and shooter motors are off

    intakeSubsystem.setDefaultCommand(new IntakeCommand(intakeSubsystem));
    shooterSubsytem.setDefaultCommand(new ShooterCommand(shooterSubsytem));
  ...
  private void configureButtonBindings() {
      ...
      new JoystickButton(ps4Controller, 3).whileHeld(new IntakeCommand(intakeSubsystem));
      new JoystickButton(ps4Controller, 4).whileHeld(new ShooterCommand(shooterSubsytem));

      new JoystickButton(ps4Controller, 5).whileHeld(new ParallelCommandGroup(
        new IntakeCommand(intakeSubsystem), new ShooterCommand(shooterSubsytem)
      ));
